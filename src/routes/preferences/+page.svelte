	...
	{:else}
		...
		<details class="summary-section">
			...
			<ul>
				...
				<li>Each pair uses <strong>two different temperatures</strong> — one low (0.3-0.5) and one high (0.7-0.9) — to create meaningful variation in style and creativity.</li>
